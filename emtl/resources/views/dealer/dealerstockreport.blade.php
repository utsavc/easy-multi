...
<div class="container-fluid">
	...
	<div class="card card-info">
		...
		<div class="card-body">
			...
			<a href="{{route('dealerStockIn',$product_id)}}" class="btn btn-warning">View Stock Recorded</a>
			<a href="{{route('dealerStockOut',$product_id)}}" class="btn btn-primary">View Stock Transferred</a>
