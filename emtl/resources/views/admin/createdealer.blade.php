				...
				<form role="form" action="">
					<div class="card-body">
						...
						<div class="form-group">
							...
							<input type="text" name="name" class="form-control" placeholder="Eg. ABC Traders">
						</div>


						<div class="form-group">
							<label for="exampleInputPassword1">Dealer Id</label>
							<input type="text" name="dealerId" class="form-control" placeholder="Eg. 1002345">
						</div>
						...
						<div class="form-group">
							...
							<input type="text" name="address" class="form-control" placeholder="Eg. Bharatpur">
						</div>
						...
						<div class="form-group">
							...
							<input type="text" name="phone" class="form-control" placeholder="Eg. 900010001">
						</div>		


						<div class="form-group">
							<label for="exampleInputPassword1">Email</label>
							<input type="email" name="email" class="form-control" placeholder="Eg. abc@mail.com">
						</div>	
